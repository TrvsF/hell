...
function NewFrame(time) {
    ...
    var display_w = exports.gl && exports.gl.drawingBufferWidth || w;
    var display_h = exports.gl && exports.gl.drawingBufferHeight || h;
    io.DisplaySize.x = w;
    io.DisplaySize.y = h;
...
function RenderDrawData(draw_data) {
    if (draw_data === void 0) { draw_data = ImGui.GetDrawData(); }
    var io = ImGui.GetIO();
    if (draw_data === null) {
        throw new Error();
    }
    ...
    var gl2 = typeof WebGL2RenderingContext !== "undefined" && exports.gl instanceof WebGL2RenderingContext && exports.gl || null;
    var gl_vao = exports.gl && exports.gl.getExtension("OES_vertex_array_object") || null;
    // Backup GL state
    var last_active_texture = exports.gl && exports.gl.getParameter(exports.gl.ACTIVE_TEXTURE) || null;
    var last_program = exports.gl && exports.gl.getParameter(exports.gl.CURRENT_PROGRAM) || null;
    var last_texture = exports.gl && exports.gl.getParameter(exports.gl.TEXTURE_BINDING_2D) || null;
    var last_array_buffer = exports.gl && exports.gl.getParameter(exports.gl.ARRAY_BUFFER_BINDING) || null;
    var last_element_array_buffer = exports.gl && exports.gl.getParameter(exports.gl.ELEMENT_ARRAY_BUFFER_BINDING) || null;
    var last_vertex_array_object = gl2 && gl2.getParameter(gl2.VERTEX_ARRAY_BINDING) || exports.gl && gl_vao && exports.gl.getParameter(gl_vao.VERTEX_ARRAY_BINDING_OES) || null;
    // GLint last_polygon_mode[2]; glGetIntegerv(GL_POLYGON_MODE, last_polygon_mode);
    var last_viewport = exports.gl && exports.gl.getParameter(exports.gl.VIEWPORT) || null;
    var last_scissor_box = exports.gl && exports.gl.getParameter(exports.gl.SCISSOR_BOX) || null;
    var last_blend_src_rgb = exports.gl && exports.gl.getParameter(exports.gl.BLEND_SRC_RGB) || null;
    var last_blend_dst_rgb = exports.gl && exports.gl.getParameter(exports.gl.BLEND_DST_RGB) || null;
    var last_blend_src_alpha = exports.gl && exports.gl.getParameter(exports.gl.BLEND_SRC_ALPHA) || null;
    var last_blend_dst_alpha = exports.gl && exports.gl.getParameter(exports.gl.BLEND_DST_ALPHA) || null;
    var last_blend_equation_rgb = exports.gl && exports.gl.getParameter(exports.gl.BLEND_EQUATION_RGB) || null;
    var last_blend_equation_alpha = exports.gl && exports.gl.getParameter(exports.gl.BLEND_EQUATION_ALPHA) || null;
    var last_enable_blend = exports.gl && exports.gl.getParameter(exports.gl.BLEND) || null;
    var last_enable_cull_face = exports.gl && exports.gl.getParameter(exports.gl.CULL_FACE) || null;
    var last_enable_depth_test = exports.gl && exports.gl.getParameter(exports.gl.DEPTH_TEST) || null;
    var last_enable_scissor_test = exports.gl && exports.gl.getParameter(exports.gl.SCISSOR_TEST) || null;
    ...
    var idx_buffer_type = exports.gl && ((ImGui.DrawIdxSize === 4) ? exports.gl.UNSIGNED_INT : exports.gl.UNSIGNED_SHORT) || 0;
        ...
        draw_list.IterateDrawCmds(function (draw_cmd) {
            ...
            if (!exports.gl && !exports.ctx) {
                ...
                for (var i = 0; i < Math.min(3, draw_cmd.ElemCount); ++i) {
                    var view = new ImGui.DrawVert(draw_list.VtxBuffer.buffer, draw_list.VtxBuffer.byteOffset + i * ImGui.DrawVertSize);
                    console.log("".concat(i, ": ").concat(view.pos[0].toFixed(2), " ").concat(view.pos[1].toFixed(2), " ").concat(view.uv[0].toFixed(5), " ").concat(view.uv[1].toFixed(5), " ").concat(("00000000" + view.col[0].toString(16)).substr(-8)));
                }
            }
            if (draw_cmd.UserCallback !== null) {
                ...
                var clip_rect = new ImGui.Vec4(draw_cmd.ClipRect.x - pos.x, draw_cmd.ClipRect.y - pos.y, draw_cmd.ClipRect.z - pos.x, draw_cmd.ClipRect.w - pos.y);
                if (clip_rect.x < fb_width && clip_rect.y < fb_height && clip_rect.z >= 0.0 && clip_rect.w >= 0.0) {
                    ...
                    if (exports.ctx) {
                        ...
                        for (var i = 0; i < draw_cmd.ElemCount; i += 3) {
                            ...
                            var i1 = idx[i + 1];
                            var i2 = idx[i + 2];
                            var v0 = new ImGui.DrawVert(draw_list.VtxBuffer.buffer, draw_list.VtxBuffer.byteOffset + i0 * ImGui.DrawVertSize);
                            var v1 = new ImGui.DrawVert(draw_list.VtxBuffer.buffer, draw_list.VtxBuffer.byteOffset + i1 * ImGui.DrawVertSize);
                            var v2 = new ImGui.DrawVert(draw_list.VtxBuffer.buffer, draw_list.VtxBuffer.byteOffset + i2 * ImGui.DrawVertSize);
                            var i3 = idx[i + 3];
                            var i4 = idx[i + 4];
                            var i5 = idx[i + 5];
                            var v3 = new ImGui.DrawVert(draw_list.VtxBuffer.buffer, draw_list.VtxBuffer.byteOffset + i3 * ImGui.DrawVertSize);
                            var v4 = new ImGui.DrawVert(draw_list.VtxBuffer.buffer, draw_list.VtxBuffer.byteOffset + i4 * ImGui.DrawVertSize);
                            var v5 = new ImGui.DrawVert(draw_list.VtxBuffer.buffer, draw_list.VtxBuffer.byteOffset + i5 * ImGui.DrawVertSize);
                            var quad = true;
                            var minmin = v0;
                            var minmax = v0;
                            var maxmin = v0;
                            ...
                            if (quad) {
                                if (minmin.uv[0] === maxmax.uv[0] || minmin.uv[1] === maxmax.uv[1]) {
                                    ...
                                    exports.ctx.fillStyle = "rgba(".concat(v0.col[0] >> 0 & 0xff, ", ").concat(v0.col[0] >> 8 & 0xff, ", ").concat(v0.col[0] >> 16 & 0xff, ", ").concat((v0.col[0] >> 24 & 0xff) / 0xff, ")");
                                    exports.ctx.fill();
                                }
                                else {
                                    // no vertex color
...
function CreateFontsTexture() {
    var io = ImGui.GetIO();
    // Backup GL state
    var last_texture = exports.gl && exports.gl.getParameter(exports.gl.TEXTURE_BINDING_2D);
    // Build texture atlas
